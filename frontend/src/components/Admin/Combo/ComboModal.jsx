...
const ComboModal = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await comboApi.createCombo(formData);

            if (response.status === 201 || response.status === 200) {
                showMessage('Combo created successfully!', 'success');
                setTimeout(() => {
                    navigate('/admin');
                }, 2000);
            } else {
    ...
    return (
        <div className="container mx-auto px-5 py-10">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <h1 className="text-2xl font-bold text-gray-800 mb-6">Create New Combo</h1>
                    ...
                    <div className="flex justify-end space-x-3 mt-6">
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    <Save size={18} className="mr-2" /> Save Combo
                                </>
                            )}
                        </button>
                    </div>
