...
const CosmeticAdminPage = () => {
    ...
    const [products, setProducts] = useState([
        { id: 1, name: "Rose Facial Cream", category: "Skincare", price: 24.99, stock: 45, image: "/api/placeholder/80/80" },
        { id: 2, name: "Velvet Matte Lipstick", category: "Makeup", price: 18.50, stock: 32, image: "/api/placeholder/80/80" },
        { id: 3, name: "Hyaluronic Acid Serum", category: "Skincare", price: 35.99, stock: 18, image: "/api/placeholder/80/80" },
        { id: 4, name: "Mineral Foundation", category: "Makeup", price: 29.99, stock: 27, image: "/api/placeholder/80/80" },
        { id: 5, name: "Lavender Bath Salts", category: "Bath & Body", price: 12.99, stock: 56, image: "/api/placeholder/80/80" },
    ]);
    ...
    return (
        <div className="min-h-screen min-w-screen bg-gray-50">
            {/* Header */}
            <header className="p-4 shadow-md" style={{ background: 'linear-gradient(105deg, #D14D72, #ffe9ef)' }}>
